...
2. **Clone this repository.** - `git clone https://github.com/zuoqin/notebook.git` or [download the zip](https://github.com/zuoqin/notebook/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd notebook`
...
sudo nohup babel-node tools/distServer.js